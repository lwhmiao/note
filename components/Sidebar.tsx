...
import { Calendar, FileText, LayoutDashboard, Settings, Coffee, NotebookText, Heart, Layers, Activity } from 'lucide-react';
  ...
  return (
    <div className={baseClass}>
      ...
      <nav className="flex-1 px-3 space-y-1 overflow-y-auto overflow-x-hidden sidebar-nav">
        ...
        <div className="mt-6 px-4 py-2 text-xs font-semibold text-notion-dim uppercase tracking-wider">身心</div>
        <MenuItem view={ViewMode.HEALTH} icon={Activity} label="身心观测站" />
      </nav>
