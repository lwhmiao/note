  ...
  return (
    <div className="fixed inset-0 z-[60] bg-notion-bg flex flex-col overflow-x-hidden" style={{ 
      ...
      <div 
        ...
        className="relative z-10 flex-1 overflow-y-auto p-4 space-y-6 max-w-4xl mx-auto w-full pb-1 overflow-x-hidden" 
        onClick={() => setActiveMenuId(null)}
      >
        {displayMessages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center text-notion-dim space-y-6 opacity-60 py-20">
